 ...
 */
?> 
<div id="surgeon-node-form" class="node-form">
  <div class="standard">
    <table>
	  <tr>
	    <td class="sg-title" class="wide" colspan="2" ><div><?php print $form['group_general']['#title']?></div></td>
	  </tr>
	  <tr>
		<td><?php print drupal_render($form['title']); ?></td>
		<td><?php print drupal_render($form['group_general']['field_sg_age']); ?></td>
	  </tr>
	  <tr>
		<td><?php print drupal_render($form['group_general']['field_sg_gender']); ?></td>
		<td><?php print drupal_render($form['group_general']['field_sg_dob']); ?></td>
	  </tr>
	  <tr>
		<td><?php print drupal_render($form['group_general']['field_sg_height']); ?></td>
		<td><?php print drupal_render($form['group_general']['field_sg_weight']); ?></td>
	  </tr>
	  <tr>
	    <td class="sg-title" class="wide" colspan="2" ><div><?php print $form['group_surgery_details']['#title']?></div></td>
	  </tr>
	  <tr>
		<td><?php print drupal_render($form['group_surgery_details']['field_sg_plan_date']); ?></td>
		<td><?php print drupal_render($form['group_surgery_details']['field_sg_home_date']); ?></td>
		<?php 
		//unset($form['group_surgery_details']['field_sg_plan_date'])?>
	  </tr>
		<?php foreach ($form['group_surgery_details'] as $key => $field):?>
		  <?php if (substr($key, 0, 5) != 'field') continue?>
		  <?php if ($output = drupal_render($field)):?>
		    <tr><td class="wide <?php print $key?>" colspan="2" ><?php print $output?></td></tr>
		  <?php endif?>
		<?php endforeach;?>
	  </tr>
	  <tr>
	    <td class="sg-title" class="wide" colspan="2" ><div><?php print $form['group_medical_conditions']['#title']?></div></td>
	  </tr>
	  <tr>
		<td><?php print drupal_render($form['group_medical_conditions']['field_sg_diabetes']); ?></td>
		<td><?php print drupal_render($form['group_medical_conditions']['field_sg_thyroid']); ?></td>
	  </tr>
	  <tr>
		<td><?php print drupal_render($form['group_medical_conditions']['field_sg_heart']); ?></td>
		<td><?php print drupal_render($form['group_medical_conditions']['field_sg_lung']); ?></td>
	  </tr>
	  <tr>
		<td><?php print drupal_render($form['group_medical_conditions']['field_sg_blood_pressure']); ?></td>
		<td><?php print drupal_render($form['group_medical_conditions']['field_sg_liver']); ?></td>
	  </tr>
	  <tr>
		<td><?php print drupal_render($form['group_medical_conditions']['field_sg_blood_disorder']); ?></td>
		<td><?php print drupal_render($form['group_medical_conditions']['field_sg_cancer']); ?></td>
	  </tr>
	  <tr>
		<td><?php print drupal_render($form['group_medical_conditions']['field_sg_hiv']); ?></td>
		<td><?php print drupal_render($form['group_medical_conditions']['field_sg_depression']); ?></td>
	  </tr>
	  <tr>
		<td><?php print drupal_render($form['group_medical_conditions']['field_sg_neurologic']); ?></td>
		<td><?php print drupal_render($form['group_medical_conditions']['field_sg_anaesthesia']); ?></td>
	  </tr>
	  ...
	  <tr>
	    <td class="sg-title" class="wide" colspan="2" ><div><?php print $form['group_women']['#title']?></div></td>
	  </tr>
	  <tr>
		<td class="wide" colspan="2" ><?php print drupal_render($form['group_women']); ?></td>
	  </tr>
	  <tr>
	    <td class="sg-title" class="wide" colspan="2" ><div><?php print $form['group_women_surgery']['#title']?></div></td>
	  </tr>
		<?php foreach ($form['group_women_surgery'] as $key => $field):?>
		  <?php if (substr($key, 0, 5) != 'field') continue?>
		  <?php if ($output = drupal_render($field)):?>
		    <tr><td class="wide <?php print $key?>" colspan="2" ><?php print $output?></td></tr>
		  <?php endif?>
		<?php endforeach;?>
	  <tr>
	    <td class="sg-title" class="wide" colspan="2" ><div><?php print $form['group_medical_history']['#title']?></div></td>
	  </tr>
		<?php foreach ($form['group_medical_history'] as $key => $field):?>
		  <?php if (substr($key, 0, 5) != 'field') continue?>
		  <?php if ($output = drupal_render($field)):?>
		    <tr><td class="wide <?php print $key?>" colspan="2" ><?php print $output?></td></tr>
		  <?php endif?>
		<?php endforeach;?>
	  <tr>
	    <td class="sg-title" class="wide" colspan="2" ><div>Images</div></td>
	  </tr>
	  <tr>
		<td class="wide" colspan="2" ><?php print drupal_render($form['field_sg_images']); ?></td>
	  </tr>
	</table>
	<?php print $form_ids; ?>
