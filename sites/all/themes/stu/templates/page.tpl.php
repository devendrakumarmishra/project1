...
<body class="<?php print $classes; ?>">
  ...
  <div id="page-wrapper"><div id="page">
    <?php print $main_navigation; ?>  <!--Max create region for main navigation -->
    ...
    <div id="main-wrapper"><div id="main" class="clearfix<?php if ($primary_links || $navigation) { print ' with-navigation'; } ?>">
      ...
      <div id="content" class="column"><div class="section">
        ...
        <?php if ($title): ?>
          <?php if($node->nid == '28'||$node->nid == '30'||$node->nid == '31'||$node->nid == '32'||$node->nid == '33'){?>
			<h1 class="first-title">What Clients Say</h1>
			<h2 class="second-title"><?php print $title; ?></h2>
		  <?php }elseif($node->nid == '73'){?>
			<h1 class="first-title">PACKAGES</h1>
			<!--<h2 class="second-title"><?php //print $title; ?></h2>-->
		  <?php }else{?>
