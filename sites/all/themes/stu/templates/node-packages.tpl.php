  ...
  <div class="content">
    ...
    <h2 class="second-title"><?php echo $node->title;?></h2>
		...
		<div class="packages-image">
			<?php if($node->field_package_image[0]['filepath']){?>
			<img src="/<?php echo $node->field_package_image[0]['filepath'];?>" alt="packages-image">
			<?php }?>
		</div>
		<div class="packages-price">
		
			<?php echo strip_tags($node->body);?>
		
			<?php /*if($node->field_package_price[0]['value']){
				from $<?php echo number_format($node->field_package_price[0]['value']);?>  <?php echo strip_tags($node->body);
			else{
		...
		<div>
			<?php echo $node->field_package_how_to_book[0]['value'];?>
		</div>
		
		<div class="sub-header-black">Package inclusions</div>
		<div class="sub-header-li">
			<?php echo $node->field_package_inclusion[0]['value'];?>
		</div>
