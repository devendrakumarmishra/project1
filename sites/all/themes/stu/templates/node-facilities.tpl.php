  ...
  <div class="content">
    ...
    <h2 class="second-title"><?php echo $node->title;?></h2>
		<div class="destination-image">
			<img src="/<?php echo $node->field_facilities_image[0]['filepath'];?>" alt="destination-image">
		</div>
		<div class="destination-body">
			<?php echo $node->field_facilities_long_body[0]['value'];?>
		</div>
		...
		<div class="destination-enquire">For procedures not shown please <?php echo l("Enquire Now","node/107"); ?></div>
