...
<div class="surgeonform">
    <?php print render($form['group_general']['#prefix']);?>
      ...
      <div class="pull-right col"> <?php print drupal_render_children($form['group_general']['field_sg_first_name'])?> </div>
    </div>
	  ...
	  <div class="row">
      <div class="pull-left col"> <?php print drupal_render($form['group_general']['field_sg_age']); ?> </div>
...
<div class="example" style='margin:10px 0px;width:290px;'><img src='<?php print $base_url ?>/sites/all/themes/smo/images/email_templates/new/BreastLiftAugmenationandReduction.png' width='290px' height='85px' /></div>
</div>
...
<div class="example" style='margin:10px 0px;width:253px;display:inline-block;'><img src='<?php print $base_url ?>/sites/all/themes/smo/images/email_templates/new/FaceLift.jpg' width='253px' height='85px'/>
</div>
<div class="example" style='margin:10px 0px;width:85px;display:inline-block;'><img src='<?php print $base_url ?>/sites/all/themes/smo/images/email_templates/new/FaceLift2.jpg' width='85px' height='85px'/>
</div>
</div>
...
<div class="example" style='margin:10px 0px;width:286px;'><img src='<?php print $base_url ?>/sites/all/themes/smo/images/email_templates/new/BreastandTummyArea.jpg' width='286px' height='160px'/></div>
</div>

<div class="images-wrapper">
<div style='margin:10px 0px;'><b style="text-decoration:underline;">Arm Lift</b><div class="heading-text">Arms stretched out.</div></div>
<div class="example" style='margin:10px 0px;width:302px;'><img src='<?php print $base_url ?>/sites/all/themes/smo/images/email_templates/new/ArmLift.png' width='302px' height='85px'/>
</div>
</div>
...
<div class="example" style='margin:10px 0px;width:305px;'><img src='<?php print $base_url ?>/sites/all/themes/smo/images/email_templates/new/TummyTuckDiagram2.jpg' width='305px' height='126px'/></div>
</div>

<div class="images-wrapper">
<div style='margin:10px 0px;'><b style="text-decoration:underline;">Buttock Lift and Buttock Implants</b></div>
<div class="example" style='margin:10px 0px;width:283px;'><img src='<?php print $base_url ?>/sites/all/themes/smo/images/email_templates/new/ButtockLift.jpg' width='283px' height='85px'/></div>
</div>

<div class="images-wrapper">
<div style='margin:10px 0px;'><b style="text-decoration:underline;">Thigh Lift and Liposuction</b></div>
<div class="example" style='margin:10px 0px;width:318px;'><img src='<?php print $base_url ?>/sites/all/themes/smo/images/email_templates/new/ThighLift.jpg' width='318px' height='100px'/></div>
</div>
...
<div class="example" style='margin:10px 0px;width:419px;'><img src='<?php print $base_url ?>/sites/all/themes/smo/images/email_templates/new/HairTransplant.jpg' width='419px' height='115px'/></div>
</div>
<?php endif; ?>
...
<div class="example" style='margin:10px 0px;width:599px;'><img src='<?php print $base_url ?>/sites/all/themes/smo/images/email_templates/new/Dental.jpg' width='599px' height='92px'/></div>
</div>

<div class="images-wrapper">
<div style='margin:10px 0px;'>Also, dental x-rays and OPG if available</div>
<div class="example" style='margin:10px 0px;width:138px;'><img src='<?php print $base_url ?>/sites/all/themes/smo/images/email_templates/new/Dental2.jpg' width='138px' height='75px'/></div>
</div>
<?php endif; ?>
<style>
div.images-wrapper {
