...
<table width="100%" nobr="true">
 ...
 <?php
  ...
  <!--For clients having surgery at Vejthani Hospital and if it is before 10pm and we are providing the airport transfer, we use this row.-->
	<?php if ($field_airport_transfer == 'Stunning Makeovers Limited' && date('G') < 22):?>
	<tr>
    <td width=20% align="center"><?php print date('l jS M h:ia', $arrival_date); ?></td>
    <td width=60% align="center">
			<div class="orangetxt">ARRIVE BANGKOK</div>
...
following confirmation of your discharge time.You will be advised of your post-operative follow up appointment time and day.</div>
  ...
  <tr>
    ...
    <td width=60% align="center">
			...
			<div class="normaltxt">Please meet the driver in the Hotel lobby for your complimentary one-way transfer to Bangkok Smile Dental Clinic for your first visit.</div>
		</td>
    <td width=20% align="center">
...
Sit back and listen to Live Music while delicious Thai & International Buffet is served</div>
  ...
  if (!empty($wrapper->field_tour)):
		...
		?>
			<tr>
			<td width=20% align="center"><?php print date('l jS M h:ia',$tour->field_tour_date_time->value()); ?> <br> 
			<?php print $tour->field_tour_duration_estimated->value();?></td>
			<td width=60% align="center">
...
subject to availability – please contact reception and have your key reactivated for late check out.</div>
  ...
  if ($field_airport_transfer == 'Stunning Makeovers Limited' && $field_airport_transfer == 'Stunning Makeovers Limited'):?>
			...
			<td width=60% align="center">
				...
				<div class="normaltxt">FLIGHT <?php print $flight_number; ?> FROM BANGKOK TO <?php print $flight_to; ?> DEPARTS <?php print date('l jS M h:ia', strtotime($arrival_date)); ?></div>
				<div class="bluetxt"><b>Recommended check-in at the airport for International flights is three hours prior to departure.</b></div>
		    <div class="normaltxt">Please have a pleasant flight</div>
		  </td>
