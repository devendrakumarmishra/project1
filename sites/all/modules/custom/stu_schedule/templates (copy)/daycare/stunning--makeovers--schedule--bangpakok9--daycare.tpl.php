...
<table width="100%" nobr="true">
 ...
 <?php
  ...
  <!--For clients having surgery at Bangpakok9 Hospital and if it is before 10pm and we are providing the airport transfer, we use this row.-->
    ...
    <td width=60% align="center">
			...
			<div class="bluetxt"><b>Gate 3 Meeting Point.</b></div>
    ...
    <td width=20% align="center">
			<div class="normaltxt"><img src="<?php print $image_path; ?>/meetingpoint.jpg" width="100px"/></div>
			<div class="normaltxt"><?php print $field_hospitalname; ?><br>Tel: +66 90-198-7726</div>
...
and we are providing hospital transfers-->
  ...
  ?>
    ...
    <td width=60% align="center">
			...
			<div class="normaltxt">
			Today’s transfer will be provided by <b><?php print $field_hospitalname; ?></b>
			</div>
			<div class="normaltxt"><b>Please meet the driver in the Hotel lobby for your transfer to Bangpakok9 International  Hospital</b></div>
			<div class="normaltxt">Please go to the hotel lobby and advise the reception desk your name and room number and that you are waiting for pick up. The driver will go to reception and ask for you when he arrives.</div>
		</td>
    <td width=20% align="center">
			<div class="normaltxt"><?php print $field_hospitalname; ?> Tel: +66 90-198-7726</div>
			<div class="bluetxt small">Due to traffic congestion, pick up time may be delayed. The driver and the hospital are in contact and will adjust your appointment according to your updated ETA. If the delay is more than 15 minutes you may ask the reception desk to call +66 90-198-7726 for an update.</div>
	  </td>
  </tr>
	<?php endif; ?>
...
and we are providing hospital transfers-->
  ...
  <tr>
    ...
    <td width=20% align="center">
			<div class="normaltxt">International Patient Coordinator Tel: +66 90-198-7726</div>
	  </td>
  </tr>
	<?php endif; ?>
  ...
  <tr>
    ...
    <td width=60% align="center">
			...
			<div class="normaltxt"><b>Your surgery will be performed as an outpatient procedure and you will be able to return to the hotel today.</b></div>
			<div class="normaltxt"><b>Please meet the driver in the Hotel lobby for your transfer to Bangpakok International Hospital</b></div>
		</td>
    <td width=20% align="center">
			<div class="normaltxt"><?php print $field_hospitalname; ?> Tel: +66 90-198-7726</div>
	  </td>
  ...
  <tr>
    ...
    <td width=60% align="center">
			...
			<div class="normaltxt">As discussed and agreed with the surgeon. You are having an out-patient procedure and will not be hospitalised overnight</div>
		</td>
    <td width=20% align="center">
			<div class="normaltxt"><?php print $field_mm_surgeon;?></div>
	  </td>
...
Sit back and listen to Live Music while delicious Thai & International Buffet is served</div>
  ...
  if (!empty($wrapper->field_tour)):
		...
		?>
			...
			<td width=60% align="center">
				<div class="orangetxt"><b>TOUR <?php print $tour_name;?> DETAILS</div>
...
subject to availability – please contact reception and have your key reactivated for late check out.</div>
  ...
  $arrival_date = $wrapper->field_departure_flight_details->field_departure_date->value();
	...
	if ($field_airport_transfer == 'Stunning Makeovers Limited' && $field_flight_arranged_by != 'Stunning Makeovers Limited'):?>
			...
			<td width=20% align="center"><?php print $field_hospitalname; ?> Tel: +66 90-198-7726</td>
		</tr>
  <?php endif; ?>
