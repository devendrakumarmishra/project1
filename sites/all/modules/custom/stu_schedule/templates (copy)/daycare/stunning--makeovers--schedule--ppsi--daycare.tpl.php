...
and we are providing hospital transfers-->
  ...
  ?>
    ...
    <td width=60% align="center">
			...
			<div class="normaltxt">Today’s transfer will be provided by Vejthani Hospital.</div>
			<div class="normaltxt"><b>Please meet the driver in the Hotel lobby for your transfer to Phuket International Hospital.<b>
    ...
    <td width=20% align="center">
			<div class="normaltxt">Phuket International Aesthetic Centre<br>Ph: Ph: +66 (0) 7624 9400</div>
			<div class="bluetxt"><small>Due to traffic congestion, pick up time may be delayed. The driver and the hospital are in contact and will adjust your appointment according to your updated ETA. If the delay is more than 15 minutes you may ask the reception desk to call +66 (0) 76 25 44 25 for an update</small></div>
		</td>
  </tr>
	<?php endif; ?>
 ...
 <?php endif; ?>
  ...
  <tr>
    ...
    <td width=60% align="center">
			...
			<div class="normaltxt">Your transfer back to your hotel will be arranged by the International Patient Coordinator following confirmation of your discharge time. You will be advised of your post-operative follow up appointment time and day.</div>
  ...
  if ($field_accommodation_arranged == 'Stunning Makeovers Limited'):?>
			...
			<td width=60% align="center">
				...
				<div class="normaltxt">Please settle any costs such as telephone calls, room service or additional nights stayed. Check-out time is 11.00am. If you would like to stay in the room longer than 11.00am, additional costs apply. Please ask the reception desk about the extra cost.</div>
			</td>
			<td width=20% align="center"></td>
		</tr>
  <?php endif; ?>
  ...
  $arrival_date = $wrapper->field_departure_flight_details->field_departure_date->value();
	...
	if ($field_airport_transfer == 'Stunning Makeovers Limited' && $field_flight_arranged_by != 'Stunning Makeovers Limited'):?>
			...
			<td width=60% align="center">
				...
				<div class="normaltxt">Please check this and advise the ground services team of any changes for your return trip to the airport
Please meet the driver in the hotel lobby for your pre-paid transport to the airport for your flight</div>
			</td>
			<td width=20% align="center">Phuket International Aesthetic Centre Ph: +66 (0) 7624 9400</td>
		</tr>
  <?php endif; ?>
...
Payment may be made using cash and internationally-recognised credit cards at the time of registration before surgery.
        ...
        <div class="normaltxt">You will need local Thai Baht currency to pay for hospital registration & service fee (200THB).  </div>
        
        <div class="normaltxt">Patients that choose not to have surgery on the day of consultation or are not accepted for surgery will incur a consultation fee of THB1,000.</div>
        
        <div class="normaltxt">Payment may be made using cash and internationally-recognised credit cards at the time of registration before surgery.</div>
