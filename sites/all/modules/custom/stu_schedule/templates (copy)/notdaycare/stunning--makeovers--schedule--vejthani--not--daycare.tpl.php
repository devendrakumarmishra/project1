...
<table width="100%" nobr="true">
 ...
 <?php
  ...
  <!--For clients having surgery at Vejthani Hospital and if it is before 10pm and we are providing the airport transfer, we use this row.-->
	<?php if ($field_hospital == 67 && $field_airport_transfer == 'Stunning Makeovers Limited' && date('G') < 22):?>
	<tr>
    <td width=20% align="center"><?php print date('l jS M h:ia', $arrival_date); ?></td>
    <td width=60% align="center">
  ...
  <!--For clients having surgery at Vejthani Hospital and if it is after 10pm and we are providing the airport transfer, we use this row.-->
	<?php if ($field_hospital == 67 && $field_airport_transfer == 'Stunning Makeovers Limited' && date('G') > 22):?>
	<tr>
    <td width=20% align="center"><?php print date('l jS M h:ia', $arrival_date); ?></td>
    <td width=60% align="center">
			...
			<img src="<?php print $image_path; ?>/AOTLimo.jpg" width="100px"/>
		</td>
    <td width=20% align="center">
			<div class="normaltxt">Vejthani Hospital<br>Airport Booth<br>Ph +66-8-5223-8888</div>
	  </td>
  ...
  <!--Use this if client doing own airport transfers.-->
	<?php if ($field_hospital == 67 && $field_airport_transfer == 'Client'):?>
	<tr>
    <td width=20% align="center"><?php print date('l jS M h:ia',$arrival_date); ?></td>
    <td width=60% align="center">
			<div class="orangetxt">ARRIVE <?php print strtoupper($destination); ?></div>
...
and we are providing hospital transfers-->
  ...
  ?>
    ...
    <td width=60% align="center">
			<div class="orangetxt">TRANSFER TO VEJTHANI HOSPITAL FOR PRE-OPERATIVE CONSULTATION</div>
			<div class="bluetxt">NO FOOD OR WATER at least 6- 8 hours before appointment.</div>
			<div class="normaltxt">
			Today’s transfer will be provided by VEJTHANI Hospital. Please go to the hotel lobby and advise the reception desk your name and room number and that you are waiting for pick up. The driver will go to reception and ask for you when he arrives.
			</div>
		</td>
    <td width=20% align="center">
			<div class="normaltxt">VEJTHANI Hospital 24/7 Hotline Ph. +66-8-5223-8888</div>
			<div class="bluetxt small">Due to traffic congestion, pick up time may be delayed. The driver and the hospital are in contact and will adjust your appointment according to your updated ETA. If the delay is more than 15 minutes you may ask the reception desk to call +66-8-5223-8888 for an update.</div>
	  </td>
  </tr>
	<?php endif; ?>
...
and we are providing hospital transfers-->
  ...
  ?>
    ...
    <td width=60% align="center">
			<div class="orangetxt">ARRIVE AT VEJTHANI HOSPITAL</div>
			<div class="normaltxt"><?php print $field_hospital_address; ?> Tel: <?php print $field_hospital_contact; ?></div>
		  <div class="normaltxt">Please proceed to the International Patients Desk on LEVEL 1 to meet your Coordinator.</div>
		</td>
    <td width=20% align="center">
			<div class="normaltxt">International Patient Coordinator 24/7 Hotline Ph +66-8-5223-8888</div>
	  </td>
  </tr>
	<?php endif; ?>
  ...
  ?>
	  <tr>
    <td width=20% align="center" class="redtxt"><?php print date('l jS M h:ia',strtotime($field_consultation_date)); ?></td>
    <td width=60% align="center">
  ...
  <tr>
    ...
    <td width=60% align="center">
			...
			<div class="normaltxt"><b>Please meet the driver in the Hotel lobby for your transfer to Vejthani International Hospital</b></div>
		</td>
    <td width=20% align="center">
			<div class="normaltxt">International Patient Coordinator 24/7 Hotline Ph +66-8-5223-8888</div>
	  </td>
  ...
  <tr>
    <td width=20% align="center" class="redtxt"><?php print date('l jS M h:ia',strtotime($field_surgery_appoint_tran_time)); ?></td>
    <td width=60% align="center">
			<div class="orangetxt">TRANSFER TO VEJTHANI HOSPITAL</div>
  ...
  <tr>
    ...
    <td width=60% align="center">
			...
			<div class="redtxt">NO FOOD OR WATER at least 6- 8 hours before consultation</div>
			<div class="normaltxt"><b>Pack a bag with the recommended items listed below for your hospital admission.</b></div>
			<div class="orangetxt">VEJTHANI INTERNATIONAL HOSPITAL </div>
			<div class="normaltxt">1 Ladprao Road 111, Klong-Chan Bangkapi, Bangkok 10240 Tel: +66 (2) 734 0390/Fax +66 (2) 370 1596</div>
			<div class="bluetxt"><b>Please arrive at least 10 minutes before your appointment and proceed to the International Patients Counter.</b></div>
		</td>
    <td width=20% align="center">
			<div class="normaltxt">Own arrangements</div>
  ...
  <tr>
    ...
    <td width=60% align="center">
			...
			<div class="normaltxt">Following surgery you will recover in a private room in the Grand Wing Ward for International Patients</div>
		</td>
    <td width=20% align="center">
  ...
  <tr>
    ...
    <td width=60% align="center">
			...
			<div class="normaltxt">Your transfer back to your hotel will be arranged by the International Patient Coordinator
following confirmation of your discharge time.You will be advised of your post-operative follow up appointment time and day.</div>
