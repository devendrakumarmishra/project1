<?php
  ...
  // Fieldcollection
	...
	$offset = $default_timezone->getOffset(new DateTime("now"));
	...
	$field_room_type = $values[field_room_type][LANGUAGE_NONE][0][value];
	$field_check_in_date = date('l, jS M Y',strtotime($values[field_check_in_date][LANGUAGE_NONE][0][value]));
	$field_check_out_date = date('l, jS M Y',strtotime($values[field_check_out_date][LANGUAGE_NONE][0][value]));
	...
	$field_vip_benefits = ($values[field_vip_benefits][LANGUAGE_NONE][0][value]) ? 1 : 0;
	
	$variables['!check_in_date'] = $field_check_in_date;
	$variables['!check_out_date'] = $field_check_out_date;
  ...
  <tr>
		<td colspan=3>
		  <table class="toptable" width="100%" height="100%">
		    <tr>
		      <td width=50%>Arrival Date: <?php print date('l, jS M Y', $arrival_date); ?></td>
				  <td width=50% align="right">Destination: <?php print $destination; ?></td>
		    </tr>
		  </table>
		</td>
  </tr>
 ...
 <?php
  // Use this if we are arranging flights Refer to flight itinerary for departure time at originating airport 
   if ($field_flight_arranged_by == 'Stunning Makeovers Limited'):
		?>
		<tr>
			<td width=20% align="center"><?php print date('l jS M', $arrival_date); ?><br><?php print date('h:ia', $arrival_date); ?></td>
			<td width=60% align="center">
				<div class="orangetxt cap"><b>FLIGHT <?php print $flight_number;?> From <?php print $flight_from;?> To <?php print $flight_to;?></b>
				 </div>
  ...
  <!--For clients having surgery at Phuket Plastic Surgery Institute and if we are providing the airport transfer, we use this row.-->
    ...
    <td width=60% align="center">
			...
			<div class="orangetxt cap">FLIGHT <?php print $flight_number; ?> <?php print $flight_from; ?></div>
			<div class="normaltxt">Upon arrival at <?php print $airport; ?> Airport please complete arrival formalities, collect your luggage and proceed to <ul>Phuket International Airport Information Counter</ul></div>
 ...
 for your transfer to your Hotel</div>
  ...
  <!--DREAM HOTEL-->
	<?php if ($field_accommodation_arranged == 'Accommodation Arranged by Stunning Makeovers Limited' && $field_hotel_name == 92):?>
	  <tr>
    <td width=20% align="center"><?php print date('l jS M', strtotime("+1 hour", $field_transfers_pickup_date)); ?><br><?php print date('h:ia', strtotime("+1 hour", $field_transfers_pickup_date)); ?></td>
    <td width=60% align="center">
  ...
  <!--Use this if client having dental treatment BEFORE surgery appointment. 
	...
	<?php 
	if ($wrapper->field_dental_date->value() < $wrapper->field_surgery_appointment_date->value()):?>
	  <tr>
...
and we are providing hospital transfers-->
  ...
  ?>
	  <tr>
    <td width=20% align="center" class="redtxt"><?php print date('l jS M', strtotime($field_consultation_transfer_time)); ?><br><?php print date('h:ia', strtotime($field_consultation_transfer_time)); ?></td>
    <td width=60% align="center">
			<div class="orangetxt">TRANSFER TO PHUKET INTERNATIONAL HOSPITAL FOR PRE-OPERATIVE CONSULTATION</div>
			<div class="bluetxt">NO FOOD OR WATER at least 6- 8 hours before appointment.</div>
			<div class="normaltxt">Please meet the driver in the Hotel lobby for your transfer to Phuket International Hospital.</div>
		</td>
    <td width=20% align="center">
			<div class="normaltxt">Phuket International Aesthetic Centre<br>Ph: +66 (0) 7624 940025</div>
		</td>
...
and we are providing hospital transfers-->
  ...
  ?>
    ...
    <td width=60% align="center">
			<div class="orangetxt">ARRIVE AT PHUKET INTERNATIONAL HOSPITAL</div>
  ...
  ?>
    ...
    <td width=60% align="center">
			...
			<div class="normaltxt">Following your consultation and tests your English speaking Coordinator will arrange your transfer back to your hotel.</div>
  ...
  ?>
    ...
    <td width=60% align="center">
			<div class="orangetxt">RETURN TO HOTEL</div>
			<div class="normaltxt">You will be advised of your surgery date and time for your surgery appointment.</div>
		</td>
    <td width=20% align="center">
			<div class="normaltxt">Own arrangements</div>
	  </td>
  ...
  ?>
  <tr>
    <td width=20% align="center" class="redtxt"><?php print date('l jS M',$field_surgery_appoint_tran_time); ?><br><?php print date('h:ia',$field_surgery_appoint_tran_time); ?></td>
    <td width=60% align="center">
			...
			<div class="normaltxt"><b>Please meet the driver in the Hotel lobby for your transfer to Phuket International Hospital</b></div>
		</td>
    <td width=20% align="center"></td>
  </tr>
	<?php endif; ?>
  ...
  <tr>
    <td width=20% align="center" class="redtxt">
			<?php print date('l jS M',strtotime("+45 minutes", strtotime($field_surgery_appoint_tran_time))); //Day date Month xxTime 45 minutes after pick up from hotel; ?>
      <br><?php print date('h:ia',strtotime("+45 minutes", strtotime($field_surgery_appoint_tran_time))); ?>
    </td>
    <td width=60% align="center">
			<div class="orangetxt">ARRIVE AT PHUKET INTERNATIONAL HOSPITAL</div>
			<div class="normaltxt"><?php print $field_hospital_address; ?> Tel: <?php print $field_hospital_contact; ?> </div>
			<div class="bluetxt">Please proceed to the International Patients. Desk on LEVEL 1 to meet your Coordinator.</div>
		</td>
    <td width=20% align="center"></td>
  </tr>
  <?php endif; ?>
  ...
  <tr>
    <td width=20% align="center" class="redtxt"><?php print date('l jS M',strtotime($field_surgery_appoint_tran_time)); ?><br><?php print date('h:ia',strtotime($field_surgery_appoint_tran_time)); ?></td>
    <td width=60% align="center">
			<div class="orangetxt">TRANSFER TO PHUKET INTERNATIONAL HOSPITAL</div>
  ...
  <tr>
    ...
    <td width=60% align="center">
			...
			<div class="redtxt">NO FOOD OR WATER at least 6- 8 hours before consultation</div>
			<div class="normaltxt"><b>Pack a bag with the recommended items listed below for your hospital admission.</b></div>
			<div class="orangetxt">PHUKET INTERNATIONAL HOSPITAL</div>
			<div class="normaltxt"><?php print $field_hospital_address; ?> Tel: <?php print $field_hospital_contact; ?> </div>
			<div class="bluetxt"><b>Please arrive at least 10 minutes before your appointment and proceed to the International Patients Counter.</b></div>
		</td>
    <td width=20% align="center">
  ...
  <tr>
    ...
    <td width=60% align="center">
			...
			<div class="normaltxt">The Co-ordinator will assist you with the admission process.</div>
		</td>
    <td width=20% align="center">
 ...
 <?php endif; ?>
  ...
  <tr>
    <td width=20% align="center" class="redtxt">Date & Time TBA</td>
    <td width=60% align="center">
			<div class="orangetxt">POST SURGERY RECOVERY/ DISCHARGE AND RETURN TO HOTEL</div>
			
			<div class="normaltxt">Following your surgery the International Coordinator will arrange your transfer back to your hotel. You will be advised of your pick up time from the Hotel for your follow up appointment.</div>
      
      
      <div class="normaltxt"><b>Please ensure you understand how to contact the hospital should you need assistance or advice before your post operative consultation. <br>Please follow the surgeon’s advice on post-operative care. Should you have any concerns during your recovery period please contact the hospital coordinator or call the hospital immediately.<br>You must return to the hospital at the request of the surgeon for follow up or additional treatment/dressing changes.</b></div>
      <div class="bluetxt">PLEASE ADVISE THE DRIVER YOUR NEXT APPOINTMENT DATE AND TIME SO A TRANFER CAN BE SCHEDULED</div>
		</td>
    <td width=20% align="center">
			<div class="normaltxt">Phuket International Aesthetic Centre Ph: +66 (0) 7624 9400</div>
	  </td>
  </tr>
	<?php endif; ?>
  ...
  <tr>
	...
	<tr>
    <td width=20% align="center" class="redtxt">
			<?php print date('l jS M',strtotime($field_dental_appoint_transf_time)); ?><br><?php print date('h:ia',strtotime($field_dental_appoint_transf_time)); ?>
		</td>
    <td width=60% align="center">
	...
	<tr>
    <td width=20% align="center" class="redtxt"><?php print date('l jS M',strtotime($field_dental_appoint_transf_time)); ?><br><?php print date('h:ia',strtotime($field_dental_appoint_transf_time)); ?></td>
    <td width=60% align="center">
			...
			<div class="bluetxt">NOTE: Your Appointment is at <?php date('h:i', $field_dental_date); ?> Time</div>
		</td>
    <td width=20% align="center">
			<div class="normaltxt"><?php print $field_dental_practice_options;?><?php print $field_dental_practice_phone;?></div>
	  </td>
  ...
  if ($field_accommodation_arranged == 'Stunning Makeovers Limited' && $field_airport_transfer == 'Stunning Makeovers Limited' && date('G') == 11):?>
			<tr>
			<td width=20% align="center"><?php print date('l jS M',strtotime($field_check_out_date)); ?><br><?php print date('h:ia',strtotime($field_check_out_date)); ?></td>
			<td width=60% align="center">
...
subject to availability – please contact reception and have your key reactivated for late check out.</div>
  ...
  $arrival_date = $wrapper->field_departure_flight_details->field_departure_date->value();
	...
	if ($field_airport_transfer == 'Stunning Makeovers Limited' && $field_flight_arranged_by != 'Stunning Makeovers Limited'):?>
			<tr>
			<td width=20% align="center"><?php print date('l jS M', strtotime($field_transfers_pickup_date)); ?><br><?php print date('h:ia', strtotime($field_transfers_pickup_date)); ?></td>
			<td width=60% align="center">
			...
			<td width=20% align="center">Phuket International Aesthetic Centre Ph: +66 (0) 7624 9400</td>
		</tr>
  <?php endif; ?>
  ...
  if ($field_airport_transfer == 'Stunning Makeovers Limited' && $field_flight_arranged_by != 'Stunning Makeovers Limited'):?>
			<tr>
			<td width=20% align="center"><?php print date('l jS M', strtotime('+1 hour',strtotime($field_transfers_pickup_date))); ?><br>
			<?php print date('h:ia', strtotime('+1 hour',strtotime($field_transfers_pickup_date))); ?></td>
			<td width=60% align="center">
