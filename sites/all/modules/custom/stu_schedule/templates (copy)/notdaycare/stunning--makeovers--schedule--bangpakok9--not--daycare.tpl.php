...
and we are providing hospital transfers-->
  ...
  ?>
    ...
    <td width=60% align="center">
			...
			<div class="normaltxt">
			Today’s transfer will be provided by <b><?php print $field_hospitalname; ?></b>. Please go to the hotel lobby and advise the reception desk your name and room number and that you are waiting for pick up. The driver will go to reception and ask for you when he arrives.
			</div>
		</td>
    <td width=20% align="center">
