<?php
  ...
  else if ($field_hospital == 4814) { //Sikarin International Hospital
		$field_hospitalname = 'Sikarin International Hospital';
		$field_hospital_address = variable_get('sikarin_address','');
		$field_hospital_contact = variable_get('sikarin_phone','');	
	}
...
<table width="100%" nobr="true">
  ...
  <tr>
		<td colspan=3>
		  <table class="toptable" width="100%" height="100%">
		    <tr>
		      <td width=50% align="center"><b>Arrival Date:</b> <?php print ($arrival_date) ? date('l, jS F Y', $arrival_date) : $field_check_in_date; ?></td>
  ...
  <?php if ($field_airport_transfer == 'Hotel'):?>
      <tr>
		...
		<td width=60% align="center" class="paddingtop">
			...
			<div class="normaltxt">Upon arrival at Phuket International Airport please complete arrival formalities, collect your luggage and exit <b>GATE 2</b>. The driver will be <b>outside</b></div>
			<img src="<?php print $image_path; ?>/deevana_hotel.jpg" width="100px"/>
			<div class="normaltxt">Look for a driver holding a sign with your name for your transfer to the hotel.</div>
		</td>
		<td width=20% align="center">
			<div class="normaltxt">Deevana Resort and Spa <br>+66 76 341414 or 341415 or 341705</div>
		</td>
	</tr>
  <?php endif; ?>
 ...
 for your transfer to your Hotel</div>
      ...
      <?php if ($field_hospital == 4814):?>
        <div class="bluetxt"><b>International Arrivals Meeting Point, 2nd Floor near Door 3.</b></div>
        <span><img src="<?php print $image_path; ?>/Sikarin_Logo.png" width="200px"/></span>
        <div class="normaltxt"><b>Look for driver holding a sign with <?php print $field_hospitalname; ?> logo or your name</b></div>
      <?php endif; ?>
    ...
    <td width=20% align="center">
      ...
      <?php if ($field_hospital == 4814):?>
        <div class="normaltxt">Sikarin International Hospital<br>Ph: +662-366-9900<br>ext 3236 & 3237</div>
      <?php endif; ?>
  ...
  <!--Use this if we are providing airport transfer.-->
    ...
    <td width=20% align="center">
			<?php if (in_array($field_hospital,array(66,67,121,4814))):?>
  ...
  <!--DREAM HOTEL-->
	<?php if ($field_accommodation_arranged == 'Accommodation Arranged by Stunning Makeovers Limited' && $field_hotel_name == 92):?>
	  <tr>
    <td width=20% align="center">
      <?php print ($field_transfers_pickup_date) ? date('l, jS F', strtotime("+1 hour", $field_transfers_pickup_date)) : date('l, jS F', $wrapper->field_check_in_date->value()); ?><br>
      <?php print ($field_transfers_pickup_date) ? date('g:ia', strtotime("+1 hour", $field_transfers_pickup_date)) : ''; ?>
    </td>
    <td width=60% align="center" class="paddingtop">
			<div class="normaltxt">
...
and we are providing hospital transfers-->
  ...
  ?>
    ...
    <?php if ($field_hospital == 4814 && $field_transfer_for_consultation == 'Hospital'):?>
      <div class="normaltxt">Sikarin International Hospital<br>Ph: +662-366-9900<br>ext 3236 & 3237</div>
			<div class="bluetxt small">Due to traffic congestion, pick up time may be delayed.<br> The driver and the hospital are in contact and will adjust your appointment according to your updated ETA.<br><br> If the delay is more than 15 minutes you may ask the reception desk to call +662-366-9900 for an update.</div>
		<?php endif; ?>
		
		<?php if ($field_hospital == 4814 && $field_transfer_for_consultation == 'Stunning Makeovers Limited'):?>
      <div class="normaltxt">Mr T or his staff  <br>Ph: +66 81 8445243</div>
			<div class="bluetxt small">Due to traffic congestion, pick up time may be delayed.<br> The driver and the hospital are in contact and will adjust your appointment according to your updated ETA.<br><br> If the delay is more than 15 minutes you may ask the reception desk to call +662-366-9900 for an update.</div>
		<?php endif; ?>
...
and we are providing hospital transfers-->
  ...
  ?>
    ...
    <td width=60% align="center" class="paddingtop">
			...
			<div class="normaltxt"><?php print nl2br($field_hospital_address); ?>
        <?php if($field_hospital != 4814): ?>
        <br>Ph: <?php print $field_hospital_contact; ?>
	      <?php endif; ?>
     </div>
     
     <?php if ($field_hospital == 4814):?>
			 <div class="normaltxt"> Please proceed to the International Patients Counter to meet your Coordinator.</div>
     <?php endif; ?>
    ...
    <td width=20% align="center">
			<?php if (in_array($field_hospital, array(66,67,4814,721)) && $field_transfer_for_consultation == 'Stunning Makeovers Limited'):?>
       <div class="normaltxt">Mr T or his staff <br>Ph: +66 81 8445243</div>
			<?php endif; ?>
  ...
  <tr>
    ...
    <td width=20% align="center">Deevana Resort and Spa <br>+66 76 341414 or 341415 or 341705</td>
   </tr>
  <?php endif; ?>
  ...
  <tr>
    <td width=20% align="center">
      <?php //print date('l, jS F', $wrapper->field_surgery_appointment_date->value()); ?>
  ...
  <tr>
    ...
    <td width=20% align="center">
      ...
      <?php if ($field_transfer_surgery_appoint == 'Stunning Makeovers Limited'):?>
			  <?php if (in_array($field_hospital, array(67,66,4814,721))):?>
			    <div class="normaltxt">Mr T or his staff<br>Ph: +66 81 8445243</div>
			  <?php endif; ?>
  ...
  <tr>
    ...
    <td width=20% align="center">
      ...
      <?php if ($field_hospital == 4814 && $field_transfer_surgery_appoint == 'Hospital'):?>
      <div class="normaltxt">Sikarin International Hospital<br>Ph: +662-366-9900<br>ext 3236 & 3237</div>
      <div class="bluetxt small">Due to traffic congestion, pick up time may be delayed.<br> The driver and the hospital are in contact and will adjust your appointment according to your updated ETA. If the delay is more than 15 minutes you may ask the reception desk to call +662-366-9900 for an update</div>
			<?php endif; ?>
			
			<?php if ($field_hospital == 4814 && $field_transfer_surgery_appoint == 'Stunning Makeovers Limited'):?>
      <div class="normaltxt">Mr T or his staff<br>Ph: +66 81 8445243</div>
      <div class="bluetxt small">Due to traffic congestion, pick up time may be delayed.<br> The driver and the hospital are in contact and will adjust your appointment according to your updated ETA. If the delay is more than 15 minutes you may ask the reception desk to call +662-366-9900 for an update</div>
			<?php endif; ?>
  ...
  <tr>
    ...
    <td width=20% align="center">
      <?php if (in_array($field_hospital, array(67,66,721,4814)) && $field_transfer_surgery_appoint == 'Stunning Makeovers Limited'):?>
        <div class="normaltxt">Mr T or his staff <br>Ph: +66 81 8445243</div>
			<?php endif; ?>
  ...
  <tr >
    ...
    <td width=60% align="center" class="paddingtop">
			<div class="orangetxt">ADMISSION FOR SURGERY</div>
			<div class="normaltxt">The coordinator will assist you with the admission process.</div>
		</td>
    <td width=20% align="center">
      <?php if ($field_hospital == 4814):?>
      <div class="normaltxt">Sikarin International Hospital<br>Ph: +662-366-9900<br>ext 3236 & 3237</div>
      ...
      <div class="normaltxt">International Patient Coordinator</div>
			...
			<?php if ($field_hospital == 731):?>
      <div class="normaltxt">English speaking coordinator</div>
			<?php endif; ?>

			<?php if ($field_hospital == 721):?>
      <div class="normaltxt">International Patient Coordinator <br>Ph: +66 90-198-7726</div>
			<?php endif; ?>
	  </td>
  </tr>
  ...
  <tr>
    ...
    <td width=60% align="center" class="paddingtop">
      ...
      <div class="normaltxt">As discussed and agreed with the surgeon</div>
      <div class="normaltxt">You are having an out-patient procedure and will not be hospitalised overnight. </div>
		</td>
    <td width=20% align="center">
			<div class="normaltxt">
				<?php 
  ...
  <tr>
    <td width=20% align="center"></td>
    <td width=60% align="center" class="paddingtop">
			<div class="orangetxt">POST SURGERY RECOVERY</div>
			<div class="normaltxt">Following surgery you will recover in a private room in the International Patients Ward.</div>
		</td>
    <td width=20% align="center">
			<div class="normaltxt"></div>
	  </td>
  ...
  <tr>
    <td width=20% align="center">Date & Time TBA</td>
    <td width=60% align="center" class="paddingtop">
			<div class="orangetxt">POST SURGERY CONSULTATION</div>
			<div class="normaltxt">The surgeon will examine you and advise you of the expected discharge day.</div>
		</td>
    <td width=20% align="center">
			<div class="normaltxt"></div>
	  </td>
  ...
  <tr>
    <td width=20% align="center">Date & Time TBA</td>
    <td width=60% align="center" class="paddingtop">
			<div class="orangetxt">DISCHARGE AND RETURN TO HOTEL</div>
...
following confirmation of your discharge time.You will be advised of your post-operative follow up appointment time and day.
    ...
    <td width=20% align="center">
			<?php if (in_array($field_hospital,array(66,67,121,4814)) && $field_transfer_surgery_appoint == 'Stunning Makeovers Limited'):?>
        <div class="normaltxt">Mr T or his staff <br>Ph: +66 81 8445243</div>
			<?php endif; ?>
 ...
 <?php endif; ?>
  ...
  <tr>
    ...
    <td width=60% align="center" class="paddingtop">
			...
			<div class="normaltxt nobmargin" style="text-align:left;margin-bottom:0px;margin-left:10px;">Once you are up to it there is plenty to do during your stay in Thailand such as:
			<ul class="own_arrangements">
			...
			<div class="normaltxt notmargin" style="text-align:left;margin-top:0px;margin-left:10px;"><b>During recovery, please do not undertake activities that could risk your recovery</b></div>
		</td>
    <td width=20% align="center">
			<div class="normaltxt"></div>
	  </td>
  ...
  strtotime($field_dental_date) > strtotime($field_surgery_appointment_date)
    ...
    <td width=20% align="center">
      <?php if($field_transfer_dental_appoint == 'Hospital'): ?>
			...
			<?php endif;?>
			<?php if($field_transfer_dental_appoint == 'Stunning Makeovers Limited'): ?>
			  <?php if(in_array($field_hospital,array(67,66,121,4814))): ?>
			    <div class="normaltxt">Mr T or his staff <br>Ph: +66 81 8445243</div>
			  <?php endif;?>
  ...
  <!--If client having dental treatment -->
    ...
    <td width=20% align="center">
      ...
      <div class="normaltxt">Phuket International Aesthetic Centre <br>Ph: +66 (0) 7624 9400</div>
			...
			<?php if ($field_hospital == 721 && $field_transfer_surgery_appoint == 'Hospital'):?>
      <div class="normaltxt"> Bangpakok9 International Hospital <br>Tel: +66 90-198-7726</div>
			<?php endif; ?>
...
Sit back and listen to Live Music while delicious Thai & International Buffet is served</div>
  ...
  if ($field_airport_transfer == 'Hospital' && $field_flight_arranged_by != 'Hospital'):?>
    <tr>
      ...
      <td width=20% align="center">
        <?php if (in_array($field_hospital, array(67,66,121,4814)) && $field_airport_transfer == 'Stunning Makeovers Limited'):?>
          <div class="normaltxt">Mr T or his staff <br>Ph: +66 81 8445243</div>
        <?php endif; ?>
        ...
        <?php if ($field_hospital == 4814 && $field_airport_transfer == 'Hospital'):?>
        <div class="normaltxt"> Sikarin International Hospital<br>Ph: +662-366-9900<br>ext 3236 & 3237</div>
        <?php endif; ?>
      </td>
		</tr>
...
-->
    ...
    <tr>
      ...
      <td width=60% align="center" class="paddingtop">
				...
				<div class="bluetxt"><b>Recommended check-in at the airport for International flights is three hours prior to departure.</b></div>
			  <div class="normaltxt">Please check with the airline for any changes in the departure time of the flight and advise hotel reception if you wish to reschedule your transfer to the airport.</div>
			  <div class="normaltxt">Please meet the driver in the hotel lobby for your pre-paid transport to the airport</div>
			</td>
      <td width=20% align="center">
			  <div class="normaltxt"> Deevana Resort and Spa <br>+66 76 341414 or 341415 or 341705 </div>
  ...
  <?php endif; ?>
   ...
   <tr>
			<td width=20% align="center"></td>
			<td width=60% align="center" bgcolor="#ccc;" class="paddingtop">
				<div class="orangetxt"><b>ITEMS TO TAKE TO HOSPITAL</b></div>
				<div class="normaltxt" style="text-align:left;">
				  <ul style="text-align:left;height: 150px;" class="own_arrangements">
