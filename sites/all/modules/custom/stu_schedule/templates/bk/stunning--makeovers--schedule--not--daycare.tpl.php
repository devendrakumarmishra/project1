 ...
 for your transfer to your Hotel</div>
  ...
  <tr>
      ...
      <div class="normaltxt" align="center">
        <div class="normaltxt"><b>Exclusive FREE offers for Stunning Makeovers clients*</b></div>
				<small class="bluetxt">* must stay consecutive nights - excludes period 24th Dec to 5th January - booking made with Stunning Makeovers for entire stay</small>
			</div>
		 </td>
  </tr>
  
  <tr>
    <td width=33% valign=top><div class="normaltxt" style="padding-left:10px;"><b>5 consecutive nights</b></div>
      <ul style="padding-left:20px;" class="own_arrangements">
        <li>One-time welcome minibar <small class="bluetxt">(2 local beers & 2 soft drinks)</small></li>
      </ul>
    </td>
    <td width=33% valign=top><div class="normaltxt" style="padding-left:10px;"><b>8 consecutive nights</b></div>
      <ul style="padding-left:20px;" class="own_arrangements">
        <li>One-time welcome minibar <small class="bluetxt">(2 local beers & 2 soft drinks)</small></li>
        <li>One Set Lunch <small class="bluetxt">(food only)</small></li>
        <li>1hr Thai Massage for adult</li>
      </ul>
    </td>
    <td width=33% valign=top><div class="normaltxt" style="padding-left:10px;"><b>12 consecutive nights</b></div>
      <ul style="padding-left:20px;" class="own_arrangements">
        <li>One-time welcome minibar <small class="bluetxt">(2 local beers & 2 soft drinks)</small></li>
        <li>One Set Lunch <small class="bluetxt" >(food only)</small></li>
        <li>One Set Dinner <small class="bluetxt">(food only)</small></li>
        <li>1hr Thai Massage for adult</li>
        <li>1hr Foot Massage for adult</li>
      </ul>
    </td>
...
and we are providing hospital transfers-->
      ...
      <div class="normaltxt">Please ask for <?php print $field_mm_coordinator; ?>, your English speaking coordinator on arrival at the hospital</div>
       ...
       <div class="normaltxt">Mr T or his staff <br>Ph: +66 81 8445243</div>
        ...
        Phuket International Aesthetic Centre <br>Ph: +66 (0) 7624 940025
			...
			<?php if ($field_hospital == 731 && $field_transfer_for_consultation == 'Stunning Makeovers Limited'):?>
        Deevana Resort and Spa <br>Tel: +66 76 341414
			<?php endif; ?>
  ...
  <tr>
    ...
    <td width=60% align="center" class="paddingtop">
			<div class="orangetxt cap">ARRIVE AT <?php print $field_hospitalname;?></div>
			<div class="normaltxt"><?php print nl2br($field_hospital_address); ?> <br>Ph: <?php print $field_hospital_contact; ?><br> Please proceed to the International Patients. Desk on LEVEL 1 to meet your Coordinator.</div>
  ...
  <tr>
    ...
    <td width=60% align="center" class="paddingtop">
			...
			<div class="normaltxt">As discussed and agreed with the surgeon <br>The time of surgery will be advised by the nursing staff. </div>
		</td>
    <td width=20% align="center">
			<div class="normaltxt">
				<?php 
