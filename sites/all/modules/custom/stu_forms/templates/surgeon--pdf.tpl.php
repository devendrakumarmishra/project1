...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language->language; ?>" version="XHTML+RDFa 1.0" dir="<?php print $language->dir; ?>">
  ...
  <body>
    ...
    <div class="print-logo">
      <img src="https://stunningmakeovers.com/sites/default/files/logo.png" />
    </div>
   </div>
			...
			<td>
				<table width="100%">
				  ...
				  <tr>
				    ...
				    <td>If yes, please specify</td>
				    <td><div class="textbox"><?php print $field_sg_heart_disease_info; ?></div></td>
				  </tr>
				  <tr>
				    <td>Diabetes</td>
				    ...
				    <td>If yes, please specify</td>
				    <td><div class="textbox"><?php print $field_sg_diabetes_new_info; ?></div></td>
				  </tr>
				  <tr>
				    <td>Hypertension</td>
				    ...
				    <td>If yes, please specify</td>
				    <td><div class="textbox"><?php print $field_sg_hypertension_info; ?></div></td>
				  </tr>
				  <tr>
				    <td>Asthma</td>
				    ...
				    <td>If yes, please specify</td>
				    <td><div class="textbox"><?php print $field_sg_asthma_info; ?></div></td>
				  </tr>
				  <tr>
				    <td>Cancer</td>
				    ...
				    <td>If yes, please specify</td>
				    <td><div class="textbox"><?php print $field_sg_cancer_new_info; ?></div></td>
				  </tr>
				</table>
			</td>
	 </tr>
